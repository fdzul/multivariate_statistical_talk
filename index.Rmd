...
.blue[]
```{r, echo=FALSE, warning=FALSE, message=FALSE, error=FALSE}
load("C:/Users/felip/OneDrive/multivariate_analysis_eme/9.results/sPLS_den_inegi20_talk.RData")
round(spls2_res$prop_expl_var$X, digits = 3)

# X
round(spls2_res$prop_expl_var$Y, digits = 3)
extract_stab_comp1X
```
]
